...
import { AddCandidateDocumentsAndSummaries1773239417416 } from '../migrations/1773239417416-AddCandidateDocumentsAndSummaries';
...
export const getTypeOrmOptions = (
  ...
  migrations: [InitialStarterEntities1710000000000, AddCandidateDocumentsAndSummaries1773239417416],
