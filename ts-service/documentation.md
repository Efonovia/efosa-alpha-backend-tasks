...
1. **Document Storage abstraction** 
   - Uploaded documents are saved both in the PostgreSQL database (`candidate_documents` table) and locally to the file system (`uploads/docs/{workspaceId}/{candidateId}/{uuid}.txt`).
